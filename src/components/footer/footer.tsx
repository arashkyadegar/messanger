...
function FooterComponent(props: any) {
     ...
     return (
          <>
               <div className='fixed w-[320px] bg-pink-100 flex flex-row justify-between  gap-4 bottom-[1px] z-50 border border-gray-100'>
                    ...
                    {/* <div className='p-2 hover:bg-pink-400 hover:text-white cursor-pointer rounded-lg'>
                         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
