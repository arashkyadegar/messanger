...
function ActivityLikeComponent(props: any) {
     ...
     return (
          <>
               ...
               <div className='col-span-2 flex flex-col justify-center text-left text-xs p-1' >
                    <h6 className='font-bold'>{username}<span className='font-medium'> : liked your comment</span></h6>
...
export default ActivityLikeComponent;
